...
import { registerUser, storeToken } from "../api";
...
export default function RegisterPage() {
  /** New user registration form and logic */
  ...
  return (
    <div style={pageStyle}>
      <div style={loginBoxStyle}>
        ...
        <h2 style={{ fontWeight: 400, color: COLORS.secondary, marginTop: 4, fontSize: 22 }}>Sign Up</h2>
        <form onSubmit={handleRegister} style={{ marginTop: 24, width: '100%' }}>
